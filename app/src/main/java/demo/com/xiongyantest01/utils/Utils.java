...
public class Utils {
    private static String[] title = new String[]{"Activity跳转动画", "Win8风格图片", "下拉刷新", "省市区联动WheelView", "BaseActivity测试", "Volley框架测试", "判定是否有权限", "ContentProvider测试", "socket测试", "BinderConnection连接池", "自定义View", "柱状图"};
