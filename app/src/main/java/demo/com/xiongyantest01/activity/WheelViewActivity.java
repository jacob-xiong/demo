...
public class WheelViewActivity extends Activity implements OnWheelChangedListener {
    ...
    public void showChoose(View view) {
        if (TextUtils.isEmpty(mCurrentAreaName) && !TextUtils.isEmpty(mCurrentCityName) && mAreaDatasMap.get(mCurrentCityName) != null) {
            mCurrentAreaName = mAreaDatasMap.get(mCurrentCityName)[0];
        }
        T.showShort(this, mCurrentProviceName + mCurrentCityName + mCurrentAreaName);
    }
}
