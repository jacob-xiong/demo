...
public class MyZoomImageView extends ImageView {
            ...
            switch (msg.what) {
                ...
                case SCALING:
                    ...
                    if (count < 4) {
                        ...
                        isFinish = true;
                        if (MyZoomImageView.this.mOnViewClickListener != null && !isClicked) {
                            isClicked = true;
                            MyZoomImageView.this.mOnViewClickListener.onViewClick(MyZoomImageView.this);
                        } else {
                            isClicked = false;
                        }
                    }
    ...
    public interface OnViewClickListener {
        void onViewClick(MyZoomImageView view);
    }
